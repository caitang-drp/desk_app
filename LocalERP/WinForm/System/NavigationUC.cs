    ...
    public partial class NavigationUC : UserControl
    {
        ...
        private void initNavigation()
        {
            ...
            TreeView treeView_queryStatistic = this.getTreeView(
                new string[] { /*DataUtility.QUERY_LIB,*/ DataUtility.QUERY_PRODUCT_DETAIL, DataUtility.STATISTIC_PRODUCT, DataUtility.QUERY_CASH_DETAIL, DataUtility.STATISTIC_CASH, DataUtility.STATISTIC_PROFIT});

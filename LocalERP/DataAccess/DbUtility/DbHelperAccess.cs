...
namespace LocalERP.DataAccess
{
    class DbHelperAccess
    {
        ...
        public static readonly string CONN_STRING = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=../../ERP.mdb;Persist Security Info=True";   //注意将数据库与release或debug中的你的程序名.exe放在一个目录下，这样方便移植

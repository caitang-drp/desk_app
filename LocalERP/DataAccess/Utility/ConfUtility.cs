...
namespace LocalERP.DataAccess.Utility
{
    public static class ConfUtility
    {
        ...
        public static readonly string CONN_STRING = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Application.StartupPath + debugPath + "\\ERP-init.mdb;Persist Security Info=True";   //正式发布时数量库路径，放在bin目录下

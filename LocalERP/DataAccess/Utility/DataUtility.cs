...
namespace LocalERP.DataAccess.Utility
{
    public static class DataUtility
    {
        ...
        public const String ELEMENT_ORDER = "配件订单管理";
        public const String ELEMENT_FLOW = "配件仓库管理";
        
        public const String PRODUCT_JOB = "加工任务管理";
        public const String PRODUCT_FLOW = "成品仓库管理";
        
        public const String SELL_LIST = "销售单据列表";
        public const String SELL = "销售出库";
        public const String SELL_BACK = "销售退货";

        public const String PRODUCT_LIB = "成品查询统计";
        public const String ELEMENT_LIB = "配件查询统计";

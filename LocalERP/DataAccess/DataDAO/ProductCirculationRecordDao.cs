...
namespace LocalERP.DataAccess.DataDAO
{
    class ProductCirculationRecordDao
    {
        ...
        public List<ProductCirculationRecord> FindList(int circulationID)
        {
            ...
            string commandText = string.Format("select * from ProductCirculationRecord, Product where ProductCirculationRecord.productID = Product.ID and circulationID = {0}", circulationID);
